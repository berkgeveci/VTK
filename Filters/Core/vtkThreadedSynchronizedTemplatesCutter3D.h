...
// .SECTION Description
// vtkThreadedSynchronizedTemplatesCutter3D is an implementation of the synchronized
...
#ifndef __vtkThreadedSynchronizedTemplatesCutter3D_h
#define __vtkThreadedSynchronizedTemplatesCutter3D_h
...
class VTKFILTERSCORE_EXPORT vtkThreadedSynchronizedTemplatesCutter3D : public vtkSynchronizedTemplates3D
{
public:
  static vtkThreadedSynchronizedTemplatesCutter3D *New();

  vtkTypeMacro(vtkThreadedSynchronizedTemplatesCutter3D,vtkSynchronizedTemplates3D);
