...
class VTKFILTERSCORE_EXPORT vtkThreadedSynchronizedTemplates3D : public vtkMultiBlockDataSetAlgorithm
{
public:
...
extern int VTKFILTERSCORE_EXPORT VTK_TSYNCHRONIZED_TEMPLATES_3D_TABLE_1[];
extern int VTKFILTERSCORE_EXPORT VTK_TSYNCHRONIZED_TEMPLATES_3D_TABLE_2[];
